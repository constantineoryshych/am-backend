...
export class DefaultContentService extends ARestService {
	protected resultFieldContainer: string = "defaultContent";

	public getAll(): Promise<unknown> {
		const method = this._DAO.getAll({ populate: [{ path: "content" }] });
